...
def roll(epoch_, x_val, y_val):
    ...
    try:
        ...
        val_min_list = []
        for i in range(5):
            model_p = "saved_models/RNN/{}_{}_NIDS_RNN.hdf5".format(cur - 1, i)
...
# hyper-parameter
epoch = 10
val_path = 'saved_models/val_RNN.txt'
model_path = 'saved_models/RNN/'
mse_path = 'saved_models/mse_RNN.txt'
log_path = 'saved_models/log_RNN.txt'
...
if __name__ == '__main__':
    ...
    val_s = Dataset_adv_1('val_data/val_set_RNN.csv')
    ...
    # test
        ...
        while not loop_exit:
            ...
            if c == '2':
                # test val
                test_s = Dataset_adv_1('val_data/val_set_RNN.csv')
                x_test, y_test = test_s.items, test_s.label
                loop_exit = True
            if c == '3':
                # test bypass
                test_s = Dataset_adv_1("../data/cic_2017/adver_sets/time1_0.1_rnn_adver_example.csv")
                x_test, y_test = test_s.items, test_s.label
                loop_exit = True
