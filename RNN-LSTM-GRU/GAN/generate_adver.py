...
model_name = "gru"
model1.load_state_dict(torch.load("generator/g15_time1_generator_"+model_name+".pt"))
model1.eval()
print(model1)
sample_size = 0.1
f = open("../data/cic_2017/adver_sets/time1_" + str(sample_size) + "_"+model_name+"_adver_example.csv", "w")
f.close()
...
for data in dl:
    ...
    test.to_csv("../data/cic_2017/adver_sets/time1_" + str(sample_size) + "_"+model_name+"_adver_example.csv", mode='a', encoding="gbk",
                header=0, index=0)
