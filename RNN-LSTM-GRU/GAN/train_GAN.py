...
if __name__ == "__main__":
    ...
    model_name = 'gru'
    loaders = {"train": DataLoader(GANDataset("../models/data/time1_fail_"+model_name+".npy", "../models/data/time1_success_"+model_name+".npy"), batch_size=32, shuffle=True)
               }
    ...
    torch.save(model["generator"].state_dict(), "generator/g15_time1_generator_"+model_name+".pt")
    torch.save(model["discriminator"].state_dict(), "discriminator/g15_time1_discriminator_"+model_name+".pt")
