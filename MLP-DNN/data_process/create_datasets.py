...
def main():
    ...
    (df_train,
     ...
     df_test) = split_dataset(
        df_list, df_size=df_size, randomize=True, training_percentage=50,
    ...
    df_train.to_csv(logdir + str(df_size) + "_train_set.csv", sep=',', index=False, mode='w', line_terminator='\n',
                    encoding='utf-8')
    df_cv.to_csv(logdir + str(df_size) + "_crossval_set.csv", sep=',', index=False, mode='w', line_terminator='\n', encoding='utf-8')
    df_test.to_csv(logdir + str(df_size) + "_test_set.csv", sep=',', index=False, mode='w', line_terminator='\n', encoding='utf-8')
